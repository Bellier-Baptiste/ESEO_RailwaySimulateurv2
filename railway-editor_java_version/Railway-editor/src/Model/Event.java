...
public abstract class Event {
	...
	public Event(String startTime, String endTime, EventType type) {
		if (isTimeValid(startTime) && isTimeValid(endTime) && !isStartTimeAfterEndTime(startTime, endTime)) {
	 ...
	 * @param startTime event startTime in format "yyyy/MM/dd_HH:mm"
	 * @throws IllegalArgumentException if the provided time is invalid or after endTime
	 */
	public void setStartTime(String startTime) {
		if (isTimeValid(startTime) && !isStartTimeAfterEndTime(startTime, this.endTime)) {
			this.startTime = startTime;
		} else {
	 ...
	 * @param endTime event endTime in format "yyyy/MM/dd_HH:mm"
	 * @throws IllegalArgumentException if the provided time is invalid or before startTime
	 */
	public void setEndTime(String endTime) {
		if (isTimeValid(endTime) && !isStartTimeAfterEndTime(this.startTime, endTime)) {
			this.endTime = endTime;
		} else {
	...
	/**
	 * Parses a given string to a LocalDateTime using the custom format "yyyy/MM/dd_HH:mm".
	 * @param time The date-time string to be parsed.
	 * @return LocalDateTime representation of the provided string or null if parsing fails.
	...
	/**
	 * Checks if the provided date-time string is valid according to the custom format "yyyy/MM/dd_HH:mm".
	...
	/**
	 * Checks if the provided startTime is after the provided endTime using the custom format "yyyy/MM/dd_HH:mm".
	 * @param startTime The start date-time string to be compared.
	 * @param endTime The end date-time string to be compared.
	 * @return true if the startTime is after endTime, false otherwise or if either time is invalid.
